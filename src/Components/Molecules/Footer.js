...
const Footer = () => {
  return (
    <>
      <div className="w-[100%] h-auto bggris grid grid-cols-2fr grid-rows-2fr  ">
        <div className="logos flex justify-center items-center flex-col  p-3">
          ...
          <h6 className="text-white hidden sm:flex">Superliga Sim Racing</h6>
        </div>
        ...
        <div className="red flex flex-col justify-center items-center  p-3">
          ...
          <div className="iconos flex flex-row">
            <a href="https://www.youtube.com/@superligasimracing2022" target="_blank">
              <Image src={youtube} alt="Yotube " className="w-[60px]"></Image>
            </a>
            <a href="https://www.twitch.tv/superligasimracing" target="_blank">
              <Image src={twitch} alt="Twicth " className="w-[60px]"></Image>
            </a>
            <a href="https://www.instagram.com/superliga_simracing/" target="_blank">
              <Image
                src={instagram}
                alt="Instagram "
                className="w-[60px]"
